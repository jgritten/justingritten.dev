...
- **SaaS tenancy (authenticated):** `GET/PUT /api/v1/Tenancy/workspace|preferences`, `POST /api/v1/Tenancy/clients`, invitation accept/decline — Clerk JWT; see [ADR 0011](decisions/0011-multi-tenant-clients-and-workspace-hub.md). The SPA hub is `/saas/post-sign-in`.
