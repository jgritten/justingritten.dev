...
- **API integration artifact:** The API should expose a current OpenAPI document as a deploy artifact so future frontends (for example iOS) can integrate from a stable contract rather than reverse-engineering endpoints.
